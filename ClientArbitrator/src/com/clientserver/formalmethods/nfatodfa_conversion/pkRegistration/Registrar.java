...
public class Registrar implements Runnable, Serializable {
    ...
    private final int PORT = Configration.getPort("clientRegistrar");
    private final String HOST = Configration.getHost("clientRegistrar");
    ...
    private Registrar() {
        try {
            ...
            System.err.println("com.clientserver.formalmethods.Client.pkRegistration");
            System.err.println("Class Client Registrar");
...
// add the server to the list 
                servers.put(serverKey, server);
                System.out.println("com.clientserver.formalmethods.client.pkRegistration");
                System.out.println("Class Client Registrar");
